defmodule Phx17DevSandboxWeb.Components do
  @moduledoc """
  ...
  import Phx17DevSandboxWeb.Gettext, warn: false
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Phx17DevSandboxWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Phx17DevSandboxWeb.Gettext, "errors", msg, opts)
    end
  end
